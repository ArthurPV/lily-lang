...
int main() {
	...
	CASE(fun, check generic param with restriction, test_fun_param_generic_with_restriction);
	...
	CASE(class, super param in class constructor, test_class_super_param_in_constructor);
	...
	CASE(enum_, check enum with value by default, test_enum_with_value_by_default);
